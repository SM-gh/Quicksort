...
@size[0.6em](- En el MEJOR CASO, termina en el CENTRO de la lista, dividiéndola en dos sublistas de igual tamaño.)
@size[0.6em](- El orden de complejidad del algoritmo es O(n·log n).)
