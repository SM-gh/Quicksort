...
•@size[0.8em](En el MEJOR CASO, termina en el CENTRO de la lista, dividiéndola en dos sublistas de igual tamaño. -> Orden de complejidad del algoritmo: O(n·log n))<br>
•@size[0.8em](En el PEOR CASO, el pivote termina EN UN EXTREMO de la lista. -> Orden de complejidad del algoritmo: O(n²))<br>
